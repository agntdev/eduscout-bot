...
export interface Session {
  step?: "search" | "upload-title" | "upload-metadata" | "broadcast-message";
  pendingFile?: { fileId: string; uniqueId: string; size: number; format: string; type: string };
  pendingTitle?: string;
  pendingBroadcastSegment?: "all" | "premium";
}
